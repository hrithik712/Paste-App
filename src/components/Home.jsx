...
//         <div className="w-full flex flex-col items-start relative rounded bg-opacity-10 border border-[rgba(128,121,121,0.3)] backdrop-blur-2xl dark:bg-black hover:scale-105 transform transition-transform duration-200">
...
//             >
//               <Copy className="group-hover:text-sucess-500 stroke-white" size={20} />
//               {showTooltip && (
//                 <div className="absolute bottom-full mb-2 p-1 text-xs text-white bg-gray-800 rounded-md hover:scale-110 transition duration-400">
//                   Copy
//                 </div>
//               )}
//             </button>
...
//             className="w-full p-3 focus-visible:ring-0 dark:text-white dark:bg-black "
//             style={{
//               caretColor: theme === "light" ? "#000" : "#FFF",
//             }}
//             onFocus={(e) => (e.target.style.caretColor = "#FFF")} // set caret color to white on focus
  ...
  return (
    <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-5 items-start">
        ...
        <div className="w-full flex flex-col items-start relative rounded bg-opacity-10 border border-[rgba(128,121,121,0.3)] backdrop-blur-2xl dark:bg-black hover:scale-105 transform transition-transform duration-200 hide-scrollbar overflow-y-auto"> {/* Apply class here */}
          <div className="w-full rounded-t flex items-center justify-between gap-x-4 px-4 py-2 border-b border-[rgba(128,121,121,0.3)] dark:border-gray-600">
            <div className="w-full flex gap-x-[6px] items-center select-none group">
              <div className="w-[13px] h-[13px] rounded-full bg-[rgb(221,115,69)]" />
              <div className="w-[13px] h-[13px] rounded-full bg-[rgb(255,255,255)]" />
